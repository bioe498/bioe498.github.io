...
* A $2^4$ design tests four 2-level factors using 16 runs.
* A $2^{4-1}$ design tests four 2-level factors using 8 runs.
* A $2^3$ design tests three 2-level factors using 8 runs.
