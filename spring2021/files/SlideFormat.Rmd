...
* What is the system and the key variables?
...
* Are the data complete?
  * How many observations are incomplete?
  * Are any combinations untested, or what fraction were tested?
...
* Only describe the practically or statistically significant results. This avoids you needing to say ``significantly'' for every result.
  * **Exception:** Mention any effect that you expected to be significant but wasn't.
  * **Example:** *No change in yield between broadcast and plowed applications.*

## Conclusions

* Conclusions are subjective based on your interpretation of the results and/or judgement.
